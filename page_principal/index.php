  ...
  <div class="container-fluid">
    <a class="navbar-brand"  style="color:#649FA5">
      ...
      Bromatologia | Municipalidad de Saladillo  
            <div class="btn-group">
            <button type="button" class="btn btn-white" style="color:#649FA5"> <img src="logo.png" alt="" width="24" height="24">Inicio</button>
            <button type="button" class="btn btn-white" style="color:#649FA5"> <img src="logo.png" alt="" width="24" height="24">Usuarios</button>
            <button type="button" class="btn btn-white" style="color:#649FA5"> <img src="logo.png" alt="" width="24" height="24">Agregar</button>
            </div>
    </a>
  </div>
