...
$deletePropietarioRelation = "DELETE FROM PropietariosPerros WHERE PropietarioId = :propietarioId";
$deletePropietario = "DELETE FROM Propietarios WHERE PropietarioId = :propietarioId";
